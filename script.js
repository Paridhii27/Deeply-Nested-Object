let character = {
	...
	character1 : {
		...
		Characteristics : ["Loves waffles and fries","Introverted","Scared of confrontation"],
	...
	character2 : {
		...
		Hobbies : ["Walking","Jumping", "Playing with a ball","Licking every bit of food"],
...
let dialogue = {
	Language : "English",
	Medium : ["Written as texts", "Spoken on calls"], //How do the characters communicate 
...
let setting = {
	...
	Description : "The story is based in the current time and takes place over a year.",
	Year :	2023,
	StartsIn : October,
